...
function startTracking() {
  ...
  // Enregistrer la page actuelle comme visitée
  pagesVisited.push(window.location.pathname);

  // Ajouter un écouteur d'événements pour suivre les changements de page (SPA)
  window.addEventListener("beforeunload", () => {
    saveTrackingData();
  });
}

// Fonction pour sauvegarder les données de suivi
function saveTrackingData() {
  ...
  trackingData.totalTime += timeSpent;
  trackingData.pageDetails.push({
...
// Activer le suivi si les cookies sont acceptés
if (localStorage.getItem("cookiesAccepted") === "true") {
  startTracking();
}
